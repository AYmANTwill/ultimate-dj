...
```
┌─ Sidebar ─┐ ┌────────────── Mixer ────────────────────┐
│ Home      │ │  Library list  ║  Best Transitions     │
│ Download  │ │  ─────────────╫─────────────────       │
│ Library   │ │  …            ║  100  &friends 4A     │
│ Analyze   │ │  …            ║   95  Andalucia 4A    │
│ Mixer ◀   │ │               ║   95  L.I.F.E   4A    │
│ Setlist   │ ╞═══ drag the sash to resize ═══════════╡
│ Discover  │ │  Deck A · current     Deck B · next   │
│ Settings  │ │  ▶ play ⏹ stop        ▶ play ⇅ Sync   │
└───────────┘ │  ▓▓▓▓▓▓▓▓▓▓▓▓▓▓       ▓▓▓▓▓▓▓▓▓▓     │
              │   0:47 / 5:00          0:12 / 5:55    │
              │   A ────────●────────────────── B     │
              └────────────────────────────────────────┘
